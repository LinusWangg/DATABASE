...
def xxx(n):
    while n:
        ...
        art_title = art_author+str(n+5000000)
        art_content = "### "+str(n+5000000)
...
cur.execute("create user wyw with password '1234@abc'")
cur.execute("grant usage on schema dboper to wyw")
cur.execute("grant select,delete on article_comment to wyw")
conn.commit()
